    ...
    public class PaymentService : IPaymentService
    {
        ...
        public async Task<Response<PaymentVM>> CreateAsync(PaymentVM model)
        {
            try
            {
                ...
                payment.Description = "Payment of membership";
                ...
                return new Response<PaymentVM>(null, "Failed to create payment.", true);
            }
            catch (Exception ex)
            {
        ...
        public async Task<Response<bool>> ProcessPaymentAsync(int id)
        {
            try
            {
                var payment = await UnitOfWork.Payments.GetByIdAsync(id);
                if (payment == null)
                    return new Response<bool>(false, "Payment not found.", true);
