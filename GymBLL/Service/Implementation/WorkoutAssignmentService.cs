...
namespace GymBLL.Service.Implementation
{
    public class WorkoutAssignmentService : IWorkoutAssignmentService
    {
        ...
        //public async Task<Response<List<WorkoutAssignmentVM>>> GetByMemberIdAsync(string memberId)
        //{
        //    try
        //    {
        //        var assignments = await UnitOfWork.WorkoutAssignments.FindAsync(a => a.MemberId == memberId);
        //        var vms = assignments.Select(a => Mapper.Map<WorkoutAssignmentVM>(a)).ToList();
        //        return new Response<List<WorkoutAssignmentVM>>(vms, null, false);
        //    }
        //    catch (Exception ex)
        ...
        public async Task<Response<bool>> DeleteAsync(int id)
        {
            try
            {
                var assignment = await UnitOfWork.WorkoutAssignments.GetByIdAsync(id);
                if (assignment == null)
                    return new Response<bool>(false, "Assignment not found.", true);
