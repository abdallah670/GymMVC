    ...
    public class MembershipService : IMembershipService
    {
        ...
        public async Task<Response<MembershipVM>> UpdateAsync(MembershipVM model)
        {
            try
            {
                ...
                if (membership == null) return new Response<MembershipVM>(null, "Membership not found.", true);
                ...
                var result = await UnitOfWork.SaveAsync();
                if (result > 0) return new Response<MembershipVM>(model, null, false);
        ...
        public async Task<Response<bool>> DeleteAsync(int id)
        {
            ...
            {
                var membership = await UnitOfWork.Memberships.GetByIdAsync(id);
                if (membership == null) return new Response<bool>(false, "Membership not found.", true);
