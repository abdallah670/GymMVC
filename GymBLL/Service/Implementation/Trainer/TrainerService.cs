...
namespace GymBLL.Service.Implementation.Trainer
{
    public class Trainerservice : ITrainerService
    {
        ...
        public Trainerservice(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, IUnitOfWork unitOfWork, IMapper mapper)
        {
        ...
        public async Task<IdentityResult> Register(RegisterUserVM User)
        {
            try
            {
                var trainer = Mapper.Map<GymDAL.Entities.Users.Trainer>(User);
